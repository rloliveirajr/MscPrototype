...
class ExtendedLacWcpc(object):
    ...
    def resetLearner(self):
        ...
        self.nclasses = 2
        self.rules_size = 3
        self.test_file = "/tmp/extendedLacWcpc_test.lac"
        self.train_file_1 = "/tmp/extendedLacWcpc_train_1.lac"
        self.train_file_2 = "/tmp/extendedLacWcpc_train_2.lac"
